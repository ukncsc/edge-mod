...
import unittest
import mock
from adapters.certuk_mod.publisher_config import PublisherConfig


class PublisherConfigTests(unittest.TestCase):

    @mock.patch('adapters.certuk_mod.publisher_config.PublisherConfig._unset_all_sites')
    ...
    @mock.patch('adapters.certuk_mod.publisher_config.PublisherConfig._set_site')
    ...
    @mock.patch('adapters.certuk_mod.publisher_config.LOCAL_NAMESPACE', new='Dummy local namespace')
    @mock.patch('adapters.certuk_mod.publisher_config.LOCAL_ALIAS', new='Dummy local alias')
    @mock.patch('adapters.certuk_mod.publisher_config.get_db', autospec=True)
