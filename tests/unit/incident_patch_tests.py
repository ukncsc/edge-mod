...
class IncidentPatchTests(unittest.TestCase):
    ...
    def test_toDraft(self, mock_to_draft):
        ...
        draft_dict = {'categories' : {u'Unauthorized Access'}, 'time': {u'containment_achieved' : {u'precision':'second',u'value':u'2016-02-29T00:00:00+00:00'}}}

        incident = incident_patch.DBIncidentPatch()
        incident = incident.from_draft(draft_dict)
    ...
    def test_UpdateWithFromDraft(self, mock_update_with):
        ...
        incident = incident_patch.DBIncidentPatch()
        incident2 = incident_patch.DBIncidentPatch.from_draft(draft_dict)
