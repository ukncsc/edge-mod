define([
    ...
    return declare(StixObjectType, {
        ...
        properties: function () {
            ...
            NamedProperty.addToPropertyList(propertyList, "to", this.stixPackage.safeListGet(this.id, this.data, "header.to", "address_value", "to"));
            NamedProperty.addToPropertyList(propertyList, "cc", this.stixPackage.safeListGet(this.id, this.data, "header.cc", "address_value", "cc"));
            NamedProperty.addToPropertyList(propertyList, "bcc", this.stixPackage.safeListGet(this.id, this.data, "header.bcc", "address_value", "bcc"));
