...
publisher_urls = [
    ...
    (r'^ajax/extract_visualiser/(?P<id_>' + VALID_STIX_ID + ')$',
     'views.extract_visualiser_get', 'extract_visualiser_ajax_view'),
    (r'^ajax/extract_visualiser/item/(?P<node_id>.*)$',
     'views.extract_visualiser_item_get', 'extract_visualiser_ajax_item'),
    (r'^ajax/extract_visualiser/merge_observables/.*$',
     'views.extract_visualiser_merge_observables', 'extract_visualiser_ajax_merge_observables'),
    (r'^ajax/extract_visualiser/delete_observables/.*$',
     'views.extract_visualiser_delete_observables', 'extract_visualiser_ajax_delete_observables'),
    (r'^ajax/extract_visualiser/move_observables/.*$',
     'views.extract_visualiser_move_observables', 'extract_visualiser_ajax_move_observables'),
    (r'^ajax/extract_visualiser/get_extended/$',
     'views.extract_visualiser_get_extended', 'extract_visualiser_get_extended'),
    ...
    (r'^ajax/incident_timeline/(?P<id_>' + VALID_STIX_ID + ')$',
     'views.ajax_incident_timeline', 'ajax_incident_timeline'),
    ...
    (r'^observable_extract/(?P<output_format>[^\/]+)/(?P<obs_type_filter>[^\/]+)/(?P<id_>' +
     VALID_STIX_ID + ')/(?P<revision>[^\/]+)$', 'views.observable_extract', 'observable_extract'),
